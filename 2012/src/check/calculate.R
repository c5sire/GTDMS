...
date.dehaulm = str2days(mgt[mgt$Intervention.type=="Date of dehaulming","Date"])
date.storage = str2days(mgt[mgt$Intervention.type=="Date of storage","Date"])
...
calc.vars <- function(fp,sheet="Fieldbook"){
